...
def verify_transform_update_method(transform, test_name, upper_sequences):
...
def main():
    ...
    total_tests += 1
    if verify_transform_update_method(
...
def test_all_transform_update_methods():
    """Pytest entry point for all transform update method tests."""
    success = main()
    assert success, "Some transform update method tests failed"
