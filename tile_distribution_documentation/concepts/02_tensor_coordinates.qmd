...
coord1 = MultiIndex(size=3, values=[1, 2, 3])
coord2 = MultiIndex(size=3, values=[1, 2, 3])
coord3 = MultiIndex(size=3, values=[4, 5, 6])
...
```{=html}
<div class="mermaid" style="margin: 0 auto; display: block; width: 20%;>
flowchart LR
