...
- **[Motivation](concepts/00_motivation.qmd)** - Why a Python emulator for Composable Kernels? Learning tool, debugging capabilities, and CK vs pytensor comparison
- **[Introduction](concepts/00_introduction.qmd)** - Why tile distribution matters, GPU memory challenges, and the solution overview
...
- **Run locally**: `streamlit run ../tensor_transform_app.py`
...
- **Run locally**: `streamlit run ../thread_visualization_app.py`

### **GPU Hierarchy Visualizer** (NEW!)
Visualize how work is distributed across vectors, warps, blocks, and tiles on a GPU with interactive controls.
- **Run locally**: `streamlit run ../gpu_hierarchy_visualizer.py`
...
Ready to start? Begin with [Motivation - Why a Python Emulator?](concepts/00_motivation.qmd)!
