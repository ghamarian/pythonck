...
graph TB
    ...
    LS -->|"Forward Transform<br/>14 ÷ 12 = 1, 14 % 12 = 2"| US
...
print(f"\nUpper {upper_coord.to_list()} → Lower {lower_coord.to_list()} (empty)")
...
lower_coord = transform.calculate_lower_index(upper_coord)
print(f"\nForward: index {upper_coord.to_list()[0]} → index {lower_coord.to_list()[0]}")
...
# offset: 12 + 20 = 32
print("\nExample mapping:")
print("  Coordinate [1,2] → embed offset 12 → final offset 32")
