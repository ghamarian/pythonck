...
try:
    ...
    try:
        ...
        # Fallback: create minimal pytensor module with buffer_view
        exec("""
import sys
import types
import numpy as np
...
class BufferView:
    ...
    def __repr__(self):
        return f"BufferView(shape={self.data.shape}, dtype={self.data.dtype})"

pytensor.BufferView = BufferView
sys.modules['pytensor'] = pytensor
sys.modules['pytensor.buffer_view'] = pytensor
""")
        import pytensor
...
import numpy as np
print("✅ Buffer view modules imported successfully!")
```
