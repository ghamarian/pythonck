...
# Create unmerge transform: 2D → 1D (pack multi-dimensional to linear)
unmerge = UnmergeTransform([2, 3])  # Pack 2x3 into linear
...
# Create merge transform: 1D → 2D (split single dimension)
merge = MergeTransform([2, 3])  # Split single dimension into 2x3
